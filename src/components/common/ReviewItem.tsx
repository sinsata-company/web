    ...
    <div className="self-stretch h-48 p-4 bg-neutral-50 rounded-2xl flex-col justify-start items-start gap-2 flex">
      <div className="self-stretch justify-start items-center gap-2 inline-flex">
        ...
        <div className="grow shrink basis-0 flex-col justify-start items-start gap-1 inline-flex">
          ...
          <div className="self-stretch text-zinc-400 text-sm font-medium font-['Pretendard Variable']">
            2024.10.10
          </div>
        </div>
      </div>
      <div className="justify-start items-center gap-1 inline-flex">
        ...
        <div className="text-zinc-900 text-sm font-bold font-['Pretendard Variable'] leading-tight">
          4.0 만족해요
        </div>
      </div>
      ...
      <div className="text-zinc-400 text-sm font-bold font-['Pretendard Variable']">
        더보기
      </div>
    </div>
  )
