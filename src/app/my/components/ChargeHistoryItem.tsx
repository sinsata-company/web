  ...
  return (
    <div className="w-full bg-white rounded-xl justify-start items-center gap-4 inline-flex">
      <div className="grow shrink basis-0 flex-col justify-center items-start gap-1 inline-flex">
        <div className="text-zinc-900 text-base font-bold font-['Pretendard'] leading-snug">
          {price} 캐시 구매
        </div>
        <div className="text-zinc-400 text-xs font-normal font-['Pretendard'] leading-none">
          {moment(createdAt).format('YYYY.MM.DD HH:mm:ss')}
        </div>
      </div>
      <div className="px-4 py-3 bg-red-600/10 rounded-xl justify-start items-center gap-3 flex overflow-hidden">
        <div className="text-red-600 text-base font-medium font-['Pretendard']">
          ₩
        </div>
        <div className="text-red-600 text-base font-bold font-['Pretendard']">
          {coin}
        </div>
      </div>
    </div>
